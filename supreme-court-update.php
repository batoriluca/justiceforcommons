...
if($_GET['slug']){
    ...
    header("location: supreme-court-updates");
}
...
<body>
                    ...
                    <div class="pbmit-title-bar-content-inner">
                        ...
                        <div class="pbmit-breadcrumb">
                            <div class="pbmit-breadcrumb-inner">
                                ...
                                <span class="sep"> > </span>
                                <span><a href="/supreme-court-updates" class="home"><span>Supreme Court Updates</span></a></span>
                                <span class="sep"> > </span>
                                ...
                                <aside class="widget widget-recent-post">
                                    ...
                                    <ul class="recent-post-list">
                                        ...
                                        <li class="recent-post-list-li" onclick="onClickRedriect('<?php echo $slug; ?>')">
                                            <a class="recent-post-thum" href="/supreme-court-update/<?php echo $slug; ?>">
                                                <img src="<?php echo SERVER_HTTP_ASSET_DB.$img; ?>" class="img-fluid"
                                                alt="<?php echo $title; ?>">
                                            </a>
                                            <a href="/supreme-court-update/<?php echo $slug; ?>"><?php echo $title; ?></a>
                                            <span
    ...
    function onClickRedriect(link) {
        window.location.href = "supreme-court-update/" + link;
    }
    </script>
</body>
