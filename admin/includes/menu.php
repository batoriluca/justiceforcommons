    ...
    <div class="bg-white dark:bg-black h-full">
        ...
        <div class="flex p-4">
            <a href="/" class="main-logo flex-1 w-full">
                <img src="<?php echo SERVER_HTTP_ADMIN; ?>assets/images/logo.svg" alt="logo" class="block dark:hidden" />
                <img src="<?php echo SERVER_HTTP_ADMIN; ?>assets/images/dark-logo.svg" alt="logo" class="hidden dark:block" />
            </a>
        </div>


        <ul class="relative h-[calc(100vh-58px)] flex flex-col gap-1 overflow-y-auto overflow-x-hidden py-0 px-1"
            x-data="{ activeMenu: '<?php echo $page?>' }">
            <li class="menu nav-item">
                <a href="<?php echo SERVER_HTTP_ADMIN; ?>" class="nav-link group text-black dark:text-white"
            ...
            <li class="menu nav-item">
                <a href="<?php echo SERVER_HTTP_ADMIN; ?>attorneys" class="nav-link group" :class="{'active' : activeMenu === 'attorneys'}">
                    <div class="flex pl-5 items-center">
                        <i class="fa-solid fa-copyright"></i>
                        <span class="pl-1 text-black dark:text-white">Attorneys</span>
                    </div>
                </a>
            </li>
            
            <li class="menu nav-item">
                <a href="<?php echo SERVER_HTTP_ADMIN; ?>practice-areas" class="nav-link group" :class="{'active' : activeMenu === 'practice-areas'}">
                    <div class="flex pl-5 items-center">
                        <i class="fa-solid fa-copyright"></i>
                        <span class="pl-1 text-black dark:text-white">Practice areas</span>
                    </div>
                </a>
            </li>

            <li class="menu nav-item">
                <a href="<?php echo SERVER_HTTP_ADMIN; ?>case-type" class="nav-link group" :class="{'active' : activeMenu === 'case-type'}">
                    <div class="flex pl-5 items-center">
                        <i class="fa-solid fa-copyright"></i>
                        <span class="pl-1 text-black dark:text-white">Case type</span>
                    </div>
                </a>
            </li>

            <li class="menu nav-item">
                <a href="<?php echo SERVER_HTTP_ADMIN; ?>querys" class="nav-link group" :class="{'active' : activeMenu === 'querys'}">
                    <div class="flex pl-5 items-center">
                        <i class="fa-solid fa-copyright"></i>
                        <span class="pl-1 text-black dark:text-white">Query</span>
                    </div>
                </a>
            </li>

            <li class="menu nav-item">
                <a href="<?php echo SERVER_HTTP_ADMIN; ?>court-update" class="nav-link group" :class="{'active' : activeMenu === 'court-update'}">
                    <div class="flex pl-5 items-center">
                        <i class="fa-solid fa-copyright"></i>
                        <span class="pl-1 text-black dark:text-white">Court Updates</span>
                    </div>
                </a>
            </li>

            <li class="menu nav-item">
                <a href="<?php echo SERVER_HTTP_ADMIN; ?>law-update" class="nav-link group" :class="{'active' : activeMenu === 'law-update'}">
                    <div class="flex pl-5 items-center">
                        <i class="fa-solid fa-copyright"></i>
                        <span class="pl-1 text-black dark:text-white">Law Updates</span>
                    </div>
                </a>
            </li>
