...
if (isset($_POST['action'])) {
    ...
    if (isset($_FILES['gallery']) &&  isset($_POST['titleName']) && isset($_POST['eStatus']) && isset($_POST['editor1'])) {
        ...
        if (move_uploaded_file($file_temp, $path)) {
            ...
            $result = $db->insertData('courtUpdates', $mediaData);
            
            if ($result) {
                echo json_encode(['success_msg' => 'Practice Areas has been uploaded']);
                exit();
            } else {
...
<head>
    <title>New Court Update | Justice For Commons Admin Panel</title>
                        ...
                        <nav aria-label="breadcrumb" class="w-full py-1 px-1">
                            <div class="flex space-x-3">
                                ...
                                <li class="flex items-center space-x-3">
                                    ...
                                    <a href="<?php echo SERVER_HTTP_ADMIN; ?>attorneys"
                                ...
                                <li class="flex items-center">
                                    <span class="text-black/40 dark:text-white/40">/</span>
                                    <a href="javaScript:;"
                                        class="flex items-center px-3 text-black dark:text-white">Create Court Update
                                    </a>
                                </li>
                            </div>
                        </nav>
            ...
            <div class="h-[calc(100vh-73px)] overflow-y-auto overflow-x-hidden">
                <div class="p-4 sm:p-7 min-h-[calc(100vh-145px)]">
                    <div class="px-2 py-1 mb-4">
                        <p class="text-sm font-semibold text-black dark:text-white">New Court Update</p>
                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (parseJson.success_msg) {
                        Toastify({
                            text: "Practice Area has been added",
                            duration: 2000,
                            newWindow: true,
                            close: true,
                            gravity: "top",
                        ...
                        var errorMessage = parseJson.error_msg ||
                            "Practice Area has not been added";
