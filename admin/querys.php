...
<head>
    <title>Querys | Justice For Commons Admin Panel</title>
...
<body x-data="main"
                        ...
                        <nav aria-label="breadcrumb" class="w-full py-1 px-1">
                            <div class="flex space-x-3">
                                ...
                                <li class="flex items-center space-x-1">
                                    ...
                                    <a href="javaScript:;" class="flex items-center px-3 text-black dark:text-white">Query</a>
                                </li>
                            </div>
                        </nav>
                    </div>
            ...
            <div class="h-[calc(100vh-73px)] overflow-y-auto overflow-x-hidden">
                <div class="p-4 sm:p-7 min-h-[calc(100vh-145px)]">
                    <div class="px-2 py-1 mb-4 flex justify-between items-center">
                        <p class="text-sm font-semibold text-black dark:text-white">New Querys</p>
                    </div>
    ...
    document.addEventListener("alpine:init", () => {
        Alpine.data('basic', () => ({
            datatable: null,
            init() {
                fetch('apis/getQuerys') // Replace with the correct path to your PHP file
                    .then(response => response.json())
                    .then(data => {
                        this.datatable = new simpleDatatables.DataTable('#myTableStriped', {
                            data: {
                                headings: ['S. no', 'Name', 'Number', 'Subject','Edit'],
                                data: data
                            },
                            sortable: true,
                            searchable: true,
