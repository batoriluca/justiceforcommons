...
if(isset($_POST['attorneyName']) && isset($_GET['id'])){

    $errorsArray  = [];
  
    if(empty($_POST['attorneyName'])){
        $errorsArray[] = 'Attorney Name is required';
    }
    ...
    $attorneyName =  mysqli_real_escape_string($conn2, htmlspecialchars(trim($_POST['attorneyName'])));
    ...
    $result = $db->updateData('ourAttorneys', $attorneyData, $attorneyWhere);
    if ($result) {
        echo json_encode(['success_msg' => 'Attorney has been saved']);
        exit();
    } else {
...
if(isset($_GET['id']) && isset($_POST['action']) && $_POST['action'] == "productDelete"){
    ...
    $attorneyWhere = "id='$id'";
    $action1=$db->deleteData('ourAttorneys', $attorneyWhere);
    
    if ($action1) {
        echo json_encode(['success_msg' => 'Attorney has been deleted']);
        exit();
    }else{
        echo json_encode(['error_msg' => 'Something went wrong']);
        exit();
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <label class="mt-1.5 flex -space-x-px">
                                                        <input
                                                            ...
                                                            placeholder="Attorney Name*" id="attorneyName"
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (parseJson.success_msg) {
                            Toastify({
                                text: "Attorney has been updated",
                                duration: 2000,
                                newWindow: true,
                                close: true,
    ...
    function deleteProduct(id) {
        jQuery.ajax({
            ...
            success: function(result) {
                ...
                if (parseJson.success_msg) {
                    Toastify({
                        text: "Attorney has been deleted",
                        duration: 2000,
                        newWindow: true,
                        close: true,
                        gravity: "top", // `top` or `bottom`
