...
if(isset($_GET['id']) && isset($_POST['action']) && $_POST['action'] == "productDelete"){
    ...
    $attorneyWhere = "id='$id'";
    $action1=$db->deleteData('contactUs', $attorneyWhere);
...
<head>
    <title>Query Details | Justice For Commons Admin Panel</title>
                        ...
                        <nav aria-label="breadcrumb" class="w-full py-1 px-1">
                            <div class="flex space-x-3">
                                ...
                                <li class="flex items-center space-x-3">
                                    ...
                                    <a href="<?php echo SERVER_HTTP_ADMIN; ?>querys"
                                        class="flex items-center text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white">New
                                        Query</a>
                                </li>
                                <li class="flex items-center">
                                    <span class="text-black/40 dark:text-white/40">/</span>
                                    <a href="javaScript:;"
                                        class="flex items-center px-3 text-black dark:text-white">Query
                                        Details</a>
                                </li>
                            </div>
                        </nav>
            ...
            <div class="h-[calc(100vh-73px)] overflow-y-auto overflow-x-hidden">
                <div class="p-4 sm:p-7 min-h-[calc(100vh-145px)]">
                    <div class="px-2 py-1 mb-4">
                        <p class="text-sm font-semibold text-black dark:text-white">Query Details</p>
                    </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <label class="mt-1.5 flex -space-x-px">
                                                        <input
                                                            ...
                                                            value="<?php echo $attorneyData[0]['name'];?>" type="text" disabled>
                                                    </label>
                                                </div>
                                                <div class="mb-4">
                                                    ...
                                                    <label class="mt-1.5 flex -space-x-px">
                                                        <input
                                                            class="form-input w-full bg-white/20 rounded-lg border border-black/10 dark:border-white/10 px-3 py-2.5 placeholder:text-black/60 dark:placeholder:text-white/60 hover:z-10 hover:border-black dark:hover:border-white focus:z-10 focus:border-black dark:focus:border-white"
                                                            value="<?php echo $attorneyData[0]['number'];?>" type="text" disabled>
                                                    </label>
                                                </div>
                                                <div class="mb-4">
                                                    ...
                                                    <label class="mt-1.5 flex -space-x-px">
                                                        <textarea
                                                            class="form-input w-full bg-white/20 rounded-lg border border-black/10 dark:border-white/10 px-3 py-2.5 placeholder:text-black/60 dark:placeholder:text-white/60 hover:z-10 hover:border-black dark:hover:border-white focus:z-10 focus:border-black dark:focus:border-white" disabled><?php echo $attorneyData[0]['msg'];?></textarea>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="basis-full md:basis-1/2 pr-0 md:pr-10">
                                                <div class="mb-4">
                                                    <p class="text-sm font-semibold mb-2">Subject*</p>
                                                    <label class="mt-1.5 flex -space-x-px">
                                                        <input
                                                            class="form-input w-full bg-white/20 rounded-lg border border-black/10 dark:border-white/10 px-3 py-2.5 placeholder:text-black/60 dark:placeholder:text-white/60 hover:z-10 hover:border-black dark:hover:border-white focus:z-10 focus:border-black dark:focus:border-white"
                                                            value="<?php echo $attorneyData[0]['subject'];?>" disabled
                                                            type="text">
                                                    </label>
                                                </div>
                                                <div class="mb-4">
