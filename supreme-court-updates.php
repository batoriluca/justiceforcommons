                    ...
                    <div class="pbmit-title-bar-content-inner">
                        <div class="pbmit-tbar">
                            <div class="pbmit-tbar-inner container">
                                <h1 class="pbmit-tbar-title"> Supreme Court Updates</h1>
                            </div>
                        </div>
                        <div class="pbmit-breadcrumb">
                            <div class="pbmit-breadcrumb-inner">
                                ...
                                <span class="sep"> > </span>
                                <span><span class="post-root post post-post current-item"> Supreme Court Updates</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <article class="pbmit-box-blog pbmit-blogbox-style-1">
                                <div class="post-item">
                                    <div class="pbmit-blog-image-with-meta">
                                        ...
                                        <div class="pbmit-meta-date"><?php echo $formattedDate1; ?> <span><?php echo $formattedDate2; ?> </span></div>
                                    </div>
                                    <div class="pbmit-box-content">
                                        <div class="pbmit-box-title">
                                            <h4><a href="supreme-court-update/<?php echo $slug; ?>"><?php echo $title; ?></a>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
